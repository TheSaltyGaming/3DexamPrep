...
void render(GLFWwindow* window, Shader ourShader, unsigned VAO)
{
    ...
    testingPyramid.globalPosition.y += 3.0f;
...
int main()
{
    ...
    std::vector<Vertex> vertices = {
        ...
        { glm::vec3(0.5f, -0.5f, 0.0f), glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f) },
        { glm::vec3(0.0f, 0.5f, 0.0f), glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, 0.0f, 1.0f) }
    };
